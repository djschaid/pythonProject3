...
## define I/O files
infile_name = "/research/bsi/projects/pcprs/s214922.pcprs/scripts/schaid/LocalAnces/simcor.json"
outfile_name = "logistic_ridge.hdf5"
...
# print("logistic iterations = ", it)
# print("ncov = ", ncov, ", npen = ", npen)
